    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('divice_token', models.CharField(blank=True, max_length=10000, null=True)),
                ('divice_type', models.CharField(blank=True, max_length=10000, null=True)),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.Group', verbose_name='groups')),
                ('role', models.ManyToManyField(blank=True, null=True, related_name='user_role', to='accounts.UserRole')),
